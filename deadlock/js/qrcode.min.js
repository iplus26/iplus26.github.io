...
( function() {
    ...
    QRCodeModel.prototype = {
        ...
        makeImpl: function(test, maskPattern) {
            ...
            this.setupPositionProbePattern(0, 0);this.setupPositionProbePattern(this.moduleCount - 7, 0);this.setupPositionProbePattern(0, this.moduleCount - 7);this.setupPositionAdjustPattern();this.setupTimingPattern();this.setupTypeInfo(test, maskPattern);
    ...
    var QRUtil = {
        ...
        getLengthInBits: function(mode, type) {
            if (1 <= type && type < 10) {
                switch (mode) {
                    case QRMode.MODE_NUMBER:return 10;case QRMode.MODE_ALPHA_NUM:return 9;case QRMode.MODE_8BIT_BYTE:return 8;case QRMode.MODE_KANJI:return 8;default:
                ...
                switch (mode) {
                    case QRMode.MODE_NUMBER:return 14;case QRMode.MODE_ALPHA_NUM:return 13;case QRMode.MODE_8BIT_BYTE:return 16;case QRMode.MODE_KANJI:return 12;default:
                        throw new Error("mode:" + mode);
                }
            } else {
...
new QRCode(document.getElementById("wechat-qrcode"), {
    text: 'http://weixin.qq.com/r/a-p2bhfEKEpXrVMN9695',
    height: 128,
    width: 128,
    colorDark: '#263238',
    colorLight: '#84FFFF'
